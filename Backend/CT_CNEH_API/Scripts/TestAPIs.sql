...
PRINT '1. https://localhost:54875/api/Agents';
PRINT '2. https://localhost:54875/api/CCTs';
PRINT '3. https://localhost:54875/api/ChefsCentre';
PRINT '4. https://localhost:54875/api/Formations/types';
PRINT '5. https://localhost:54875/api/Formations';
PRINT '';
