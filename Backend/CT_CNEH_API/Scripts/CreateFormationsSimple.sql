-- Script simple de création des tables Formation
-- Crée les tables avec de nouveaux noms pour éviter les conflits

USE CT_CNEH_DB;
GO

PRINT '=== CRÉATION SIMPLE DES TABLES FORMATION ===';
PRINT '';
...
PRINT '';
PRINT '=== CRÉATION SIMPLE TERMINÉE ===';
PRINT '';
PRINT '=== RÉSUMÉ ===';
PRINT '✓ Table TypesFormation_New créée avec 7 types de formation';
PRINT '✓ Table Formations_New créée avec index et contraintes';
