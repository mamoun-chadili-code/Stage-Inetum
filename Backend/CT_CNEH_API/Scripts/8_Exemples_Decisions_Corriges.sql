-- Script corrigé pour insérer 8 exemples de décisions avec les vrais IDs
USE [CT_CNEH_DB]
GO
...
INSERT INTO [Decisions] (
    ...
    2, 2, GETDATE(), NULL, 3, 3, 4, NULL, 7
);

-- Exemple 3: Décision de Promotion pour un Agent (pas de table ChefsCentre)
INSERT INTO [Decisions] (
    [EntiteId], [DateReference], [DateDebut], [DateFin], [LienDocumentUrl], 
    [Montant], [Observation], [ReseauId], [CCTId], [CreatedAt], [UpdatedAt], 
    [TypeDecisionId], [EntiteTypeId], [AgentId], [ChefCentreId], [LigneId]
    ...
    'https://example.com/promotion-agent.pdf', 5000.00,
    'Promotion au grade de Chef de Centre Principal avec augmentation de salaire',
    1, 1, GETDATE(), NULL, 6, 4, 2, NULL, NULL
);
...
INSERT INTO [Decisions] (
    ...
    'Creation dune nouvelle ligne de controle technique pour vehicules electriques',
    3, 3, GETDATE(), NULL, 2, 5, NULL, NULL, 8
);
...
INSERT INTO [Decisions] (
    ...
    'Mutation de lagent vers le centre de controle technique de Casablanca',
    1, 1, GETDATE(), NULL, 7, 3, 6, NULL, 4
);
...
INSERT INTO [Decisions] (
    ...
    'Prime dexcellence pour performance exceptionnelle en controle qualite',
    3, 3, GETDATE(), NULL, 12, 3, 7, NULL, 9
);
...
INSERT INTO [Decisions] (
    ...
    1, 1, GETDATE(), NULL, 10, 3, 9, NULL, 5
);
