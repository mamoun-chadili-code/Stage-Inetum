...
PRINT '=== INSERTION DE DONNÉES COHÉRENTES DANS HISTORIQUE AFFECTATIONS (VERSION CORRIGÉE) ===';
GO
...
SELECT 'ChefCentres' as TableName, MIN(Id) as MinId, MAX(Id) as MaxId, COUNT(*) as Total FROM ChefCentres;
...
-- Insertion des affectations d'agents (30 affectations) - UTILISANT LES BONS IDs
...
VALUES
-- Affectations d'agents actives (sans date de fin) - IDs 2 à 11
(1, 'Agent', 9, '2023-01-15', NULL, 'Affectation initiale suite à recrutement', NULL, 1, GETDATE(), 2, NULL),
(2, 'Agent', 10, '2023-02-01', NULL, 'Transfert depuis le CCT de Casablanca', NULL, 1, GETDATE(), 3, NULL),
(3, 'Agent', 11, '2023-02-15', NULL, 'Promotion interne au poste d''agent de contrôle', NULL, 1, GETDATE(), 4, NULL),
(4, 'Agent', 12, '2023-03-01', NULL, 'Affectation suite à formation spécialisée', NULL, 1, GETDATE(), 5, NULL),
(5, 'Agent', 13, '2023-03-15', NULL, 'Transfert pour renforcer l''équipe technique', NULL, 1, GETDATE(), 6, NULL),
(6, 'Agent', 14, '2023-04-01', NULL, 'Affectation suite à restructuration', NULL, 1, GETDATE(), 7, NULL),
(7, 'Agent', 15, '2023-04-15', NULL, 'Recrutement direct pour poste vacant', NULL, 1, GETDATE(), 8, NULL),
(8, 'Agent', 28, '2023-05-01', NULL, 'Transfert depuis région voisine', NULL, 1, GETDATE(), 9, NULL),
(9, 'Agent', 9, '2023-05-15', NULL, 'Affectation temporaire pour surcharge de travail', NULL, 1, GETDATE(), 10, NULL),
(10, 'Agent', 10, '2023-06-01', NULL, 'Promotion au grade d''agent senior', NULL, 1, GETDATE(), 11, NULL),

-- Affectations d'agents avec historique (avec date de fin) - IDs 12 à 16
(11, 'Agent', 11, '2022-01-01', '2023-01-31', 'Affectation initiale', 'Transfert vers autre CCT', 0, GETDATE(), 12, NULL),
(12, 'Agent', 12, '2022-02-01', '2023-02-28', 'Affectation temporaire', 'Fin de mission temporaire', 0, GETDATE(), 13, NULL),
(13, 'Agent', 13, '2022-03-01', '2023-03-31', 'Remplacement agent en congé', 'Retour de l''agent titulaire', 0, GETDATE(), 14, NULL),
(14, 'Agent', 14, '2022-04-01', '2023-04-30', 'Affectation pour formation', 'Fin de formation', 0, GETDATE(), 15, NULL),
(15, 'Agent', 15, '2022-05-01', '2023-05-31', 'Renforcement équipe', 'Réduction d''effectifs', 0, GETDATE(), 16, NULL),

-- Affectations d'agents avec rotations - IDs 17 à 20
(16, 'Agent', 28, '2023-01-01', '2023-06-30', 'Rotation semestrielle', 'Fin de rotation', 0, GETDATE(), 17, NULL),
(17, 'Agent', 9, '2023-07-01', NULL, 'Nouvelle affectation post-rotation', NULL, 1, GETDATE(), 17, NULL),
(18, 'Agent', 10, '2023-01-01', '2023-12-31', 'Affectation annuelle', 'Fin de contrat annuel', 0, GETDATE(), 18, NULL),
(19, 'Agent', 11, '2024-01-01', NULL, 'Renouvellement de contrat', NULL, 1, GETDATE(), 18, NULL),
(20, 'Agent', 12, '2023-03-01', '2023-08-31', 'Affectation saisonnière', 'Fin de saison', 0, GETDATE(), 19, NULL),

-- Affectations d'agents avec motifs spécifiques - IDs 20 à 24
(21, 'Agent', 13, '2023-09-01', NULL, 'Affectation suite à restructuration organisationnelle', NULL, 1, GETDATE(), 20, NULL),
(22, 'Agent', 14, '2023-06-01', '2023-11-30', 'Remplacement agent en formation', 'Retour de formation', 0, GETDATE(), 21, NULL),
(23, 'Agent', 15, '2023-12-01', NULL, 'Affectation définitive post-remplacement', NULL, 1, GETDATE(), 21, NULL),
(24, 'Agent', 28, '2023-04-01', '2023-09-30', 'Mission spéciale contrôle qualité', 'Fin de mission', 0, GETDATE(), 22, NULL),
(25, 'Agent', 9, '2023-10-01', NULL, 'Affectation permanente post-mission', NULL, 1, GETDATE(), 22, NULL),

-- Affectations d'agents avec progression de carrière - IDs 23 à 26
(26, 'Agent', 10, '2022-06-01', '2023-05-31', 'Stage d''intégration', 'Fin de stage - promotion', 0, GETDATE(), 23, NULL),
(27, 'Agent', 11, '2023-06-01', NULL, 'Affectation en tant qu''agent confirmé', NULL, 1, GETDATE(), 23, NULL),
(28, 'Agent', 12, '2023-01-01', '2023-12-31', 'Formation continue', 'Fin de formation', 0, GETDATE(), 24, NULL),
(29, 'Agent', 13, '2024-01-01', NULL, 'Affectation avec responsabilités accrues', NULL, 1, GETDATE(), 24, NULL),
(30, 'Agent', 14, '2023-07-01', NULL, 'Affectation suite à évaluation positive', NULL, 1, GETDATE(), 25, NULL);

GO

-- Insertion des affectations de chefs de centre (20 affectations) - UTILISANT LES BONS IDs
...
VALUES
-- Affectations de chefs de centre actives - IDs 1 à 5
...
-- Affectations de chefs de centre avec historique - IDs 6 à 10
...
-- Affectations de chefs de centre avec rotations - IDs 6 à 10 (réutilisés)
...
-- Affectations de chefs de centre avec motifs spécifiques - IDs 11 à 15
...
SELECT TOP 10
    ...
    ha.TypeEntite,
    CASE 
        WHEN ha.TypeEntite = 'Agent' THEN CONCAT(a.Nom, ' ', a.Prenom)
        WHEN ha.TypeEntite = 'ChefCentre' THEN CONCAT(cc.Nom, ' ', cc.Prenom)
    END as NomComplet,
    cct.Nom as NomCCT,
    ha.DateAffectation,
...
PRINT 'IDs utilisés: Agents (2-25), ChefCentres (1-15), CCTs (9,10,11,12,13,14,15,28)';
GO
