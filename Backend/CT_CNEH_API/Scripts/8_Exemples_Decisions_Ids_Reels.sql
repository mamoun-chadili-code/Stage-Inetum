-- Script FINAL utilisant les VRAIS IDs de votre base de données
USE [CT_CNEH_DB]
GO
...
INSERT INTO [Decisions] (
    ...
    4, 9, GETDATE(), NULL, 5, 4, NULL, 2, NULL
);
...
INSERT INTO [Decisions] (
    ...
    6, 11, GETDATE(), NULL, 11, 5, NULL, 3, 8
);
