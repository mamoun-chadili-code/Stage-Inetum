-- Script final de correction des dates et insertion des formations
-- Utilise des valeurs DATETIME directes sans conversion

USE CT_CNEH_DB;
GO

PRINT '=== CORRECTION FINALE DES DATES ET INSERTION DES FORMATIONS ===';
PRINT '';
...
-- Insérer 7 formations de test avec des valeurs DATETIME directes
...
('BK144610_FMQA72_06/06/2022', @CCTId1, @AgentId1, @ChefCentreId1, 1,
 ...
 '2022-06-06 09:00:00', '2022-06-29 17:00:00', 1, 'BASSO ABDELFETTAH', 'BASSO ABDELFETTAH',
 1, '2022-04-26'),
...
('BK144611_FIQA73_15/07/2022', @CCTId2, @AgentId2, @ChefCentreId2, 2,
 ...
 '2022-07-15 09:00:00', '2022-08-15 17:00:00', 1, 'MOHAMED ALAMI', 'FATIMA BENNANI',
 1, '2022-06-15'),
...
('BK144612_FCDE74_10/09/2022', @CCTId1, @AgentId1, @ChefCentreId1, 3,
 ...
 '2022-09-10 09:00:00', '2022-09-25 17:00:00', 0, 'AHMED CHAIBI', 'KHADIJA DAOUDI',
 0, NULL),
...
('BK144613_FCSS75_20/10/2022', @CCTId2, @AgentId2, @ChefCentreId2, 4,
 ...
 '2022-10-20 09:00:00', '2022-11-05 17:00:00', 1, 'MUSTAPHA RESOUANY', 'MOHAMED ALAMI',
 1, '2022-10-15'),
...
('BK144614_FCVH76_05/11/2022', @CCTId1, @AgentId1, @ChefCentreId1, 5,
 ...
 '2022-11-05 09:00:00', '2022-11-20 17:00:00', 0, 'FATIMA BENNANI', 'AHMED CHAIBI',
 0, NULL),
...
('BK144615_FCPL77_15/12/2022', @CCTId3, @AgentId3, @ChefCentreId3, 6,
 ...
 '2022-12-15 09:00:00', '2023-01-15 17:00:00', 1, 'HASSAN EL AMRANI', 'KARIM BENNANI',
 1, '2022-12-10'),
...
('BK144616_FNTA78_20/01/2023', @CCTId1, @AgentId2, @ChefCentreId2, 7,
 ...
 '2023-01-20 09:00:00', '2023-02-10 17:00:00', 1, 'SALMA EL FASSI', 'YOUSSEF TAHIRI',
 1, '2023-01-15');
